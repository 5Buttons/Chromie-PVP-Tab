...
All preferences persist between game sessions. Designed for the server Chromiecraft, but works on any Azerothcore server with the respective commands enabled.
